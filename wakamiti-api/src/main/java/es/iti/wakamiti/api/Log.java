...
public class Log {
    ...
    private static final Log singleton = new Log("es.iti.wakamiti");
    ...
    public static Log of(String category) {
        return new Log("es.iti.wakamiti."+category);
    }
    ...
    public void error(Throwable throwable) {
        ...
        if (throwable instanceof WakamitiException we) {
            delegate.error(we.unformattedMessage,we.messageArguments);
        } else {
